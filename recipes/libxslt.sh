...
export PACK_NAME="libxslt"
export PACK_VERSION="$LIBXSLT_VERSION"
export PACK_SOURCE_URL="$LIBXSLT_SOURCE_URL"
export PACK_SOURCE_SHA256="$LIBXSLT_SOURCE_SHA256"
export PACK_DEPS="${PACK_DEPS:-libxml2}"
...
cd "$src_dir/libxslt-$PACK_VERSION"
